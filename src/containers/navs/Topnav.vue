    ...
    <div class="navbar-right">
      <div class="d-none d-md-inline-block align-middle mr-3">
        <switches
          ...
          color="primary"
        />
        <b-tooltip target="tool-mode-switch" placement="left" title="Темный режим"></b-tooltip>
      </div>
      ...
      <div class="user d-inline-block">
        ...
        >
          <template slot="button-content">
            ...
            <span>
              <img :alt="currentUser.title" src="https://sun2-9.userapi.com/impf/c831408/v831408957/5de08/EpkLyju8mAI.jpg?size=50x0&quality=96&crop=601,110,1539,1539&sign=c83cdb4e705a646b7d506b988b7d75a6&ava=1" />
            </span>
          </template>
